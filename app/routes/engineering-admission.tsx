  ...
  return (
    <div className="relative">
      ...
      <section className="flex flex-col items-center pb-8">
        ...
        <div className="container grid place-items-center gap-4 lg:grid-cols-2">
          {Array.from({ length: 6 }).map((_, index) => (
            <Card className="flex-col max-w-xl lg:max-w-md text-base" key={index}>
              ...
              <CardFooter className="bg-white w-full">
                <Accordion
                  type="single"
                  collapsible
                  ...
                  <AccordionItem value={`item-${index}`} className="border-b-0">
                    ...
                    <AccordionContent className="grid gap-4 text-base text-gray-500">
                      <p>
                        ...
                        Previously known as IIT-JEE, it was renamed in 2013 and
                        since then, it has been administered and regulated by
                        the seven branches of IITs (Roorkee, Kharagpur, Delhi,
                        Bombay, Kanpur, Madras and Guwahati). It consists of two
                        papers with questions drawn from Physics, Chemistry,
                        Mathematics and a Architecture Aptitude Test (AAT) for
                        candidates aspiring to enroll in an architecture course
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Subjects In Paper:</strong> Physics, Chemistry,
                        Maths, and AAT (Architecture Aptitude Test)
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
