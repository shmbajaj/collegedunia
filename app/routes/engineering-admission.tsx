  ...
  return (
    <div className="relative">
      ...
      <section className="flex flex-col items-center pb-8">
        ...
        <>
          <div className="container lg:max-w-5xl grid place-items-center gap-4 lg:grid-cols-[repeat(auto-fill,minmax(320px,448px))]">
            {Array.from({ length: 6 }).map((_, index) => (
              <Card className="flex-col text-base" key={index}>
